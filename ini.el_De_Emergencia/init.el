...
(setq user-full-name "Felipe Merino"
      user-mail-address "andres.merino01@epn.edu.ec") ; [cite: 1]
...
;; 4.1 Org Mode Basics & Babel Languages
(use-package org
  :ensure t
  :config
  ;; Org-mode settings
  ...
  ;; Carga explícita de ob-shell para soporte de shell
  (require 'ob-shell))
...
;; -----------------------------------------------------------------
;; --- CAMBIO IMPORTANTE ---
;; Se ha comentado la siguiente línea. Al no definir un intérprete de Python
;; global, Emacs respetará la configuración que pongas en las
;; "Local Variables" de cada archivo .org, lo cual es ideal para
;; trabajar con diferentes entornos de Conda por proyecto.
;; -----------------------------------------------------------------
...
;; -----------------------------------------------------------------
;; --- CAMBIO IMPORTANTE ---
;; Se ha comentado la ruta fija del intérprete de Python y se ha
;; dejado una configuración más genérica para que funcione bien con
